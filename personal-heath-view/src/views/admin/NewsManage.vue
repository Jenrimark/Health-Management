    ...
    <el-row style="background-color: #FFFFFF;padding: 5px 0;border-radius: 5px;">
        <el-row style="padding: 10px;margin-left: 5px;">
            <el-row style="display: flex;justify-content: left;gap: 6px;">
                <el-select style="width: 100px;" @change="fetchFreshData" size="small"
                    v-model="gourmetQueryDto.categoryId" placeholder="系列">
                ...
                <el-input size="small" style="width: 186px;" v-model="gourmetQueryDto.title" placeholder="标题"
        ...
        <el-row style="margin: 0 22px;border-top: 1px solid rgb(245,245,245);">
            <el-table :stripe="true" :data="tableData" style="width: 100%">
                ...
                <el-table-column prop="categoryId" :sortable="true" label="系列ID" width="98"></el-table-column>
                <el-table-column prop="categoryName" label="系列" width="98"></el-table-column>
                ...
                <el-table-column prop="isAudit" label="审核状态" width="98">
                    <template slot-scope="scope">
                        ...
                        <el-tooltip v-if="!scope.row.isAudit" class="item" effect="dark" content="未审核论坛信息，不公开访问"
    ...
    methods: {
        ...
        async batchDelete() {
            ...
            if (confirmed) {
                try {
                    ...
                    this.$message.error("论坛信息删除异常：", error);
        ...
        async fetchFreshData() {
            try {
                ...
                this.$message.error("查询论坛信息异常:", error);
                console.error('查询论坛信息异常:', error);
            }
        },
        add() {
